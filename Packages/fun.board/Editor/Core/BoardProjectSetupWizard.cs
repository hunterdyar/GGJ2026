...
namespace Board.Editor.Core
{
    ...
    internal class BoardProjectSetupWizard : EditorWindow
    {
        ...
        private const int kWindowWidth = 500;
        private const int kWindowHeight = 280;
        ...
        {
            var window = GetWindow<BoardProjectSetupWizard>(true, "Configure Unity Project");
        ...
        private void DrawSettingCheckbox(ref bool value, string prefsKey, string label, bool isCurrentlyCorrect)
        {
            ...
            if (isCurrentlyCorrect)
            {
                ...
                GUILayout.Label("[OK]", GUILayout.Width(40));
